...
--
-- Servidor: localhost
-- Tiempo de generación: 18-03-2021 a las 19:52:21
...
--
-- Base de datos: `db-denuncias-web`
--
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `LIST_DEP`()
begin
select * from da_tab_departamentos;
end$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LIST_DIST`(IN `_idProv` INT(5))
begin
select * from da_tab_distritos where idProv = _idProv;
end$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LIST_PROV`(IN `_idDep` INT(5))
begin
select * from da_tab_provincias where idDep = _idDep;
end$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `REG_DEN_ANONIMO`(IN `_FechaDenuncia` DATE, IN `_tipDenuncia` INT, IN `_emailDenun` TEXT, IN `_telDenun` TEXT, IN `_celDenun` TEXT, IN `_descDenun` TEXT, IN `_listDenunciados` TEXT, IN `_pruebasConf` TEXT, IN `_ubiPuebas` TEXT, IN `_compromiso` TEXT, IN `_comCorreo` INT(11))
begin
insert into da_tab_denuncias(FechaDenuncia,tipDenuncia,emailDenun,telDenun,celDenun,descDenun,listDenunciados,pruebasConf,ubiPuebas,compromiso,comCorreo) values (_fechaDenuncia,_tipDenuncia,_emailDenun,_telDenun,_celDenun,_descDenun,_listDenunciados,_pruebasConf,_ubiPuebas,_compromiso,_comCorreo);
end$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `REG_DEN_JURIDICA`(IN `_FechaDenuncia` DATE, IN `_tipDenuncia` INT(11), IN `_tipDocumento` INT(11), IN `_rucDenun` TEXT, IN `_razonDenun` TEXT, IN `_numDoc` TEXT, IN `_nombDenun` TEXT, IN `_apPatDenun` TEXT, IN `_apMatDenun` TEXT, IN `_depDenun` INT(5), IN `_provDenun` INT(5), IN `_distDenun` INT(5), IN `_domDenun` TEXT, IN `_emailDenun` TEXT, IN `_telDenun` TEXT, IN `_celDenun` TEXT, IN `_reservaIden` TEXT, IN `_descDenun` TEXT, IN `_listDenunciados` TEXT, IN `_pruebasConf` TEXT, IN `_ubiPuebas` TEXT, IN `_compromiso` TEXT, IN `_comCorreo` INT(11))
begin
insert into da_tab_denuncias(FechaDenuncia,tipDenuncia,tipDocumento,rucDenun,razonDenun,numDoc,nombDenun,apPatDenun,apMatDenun,depDenun,provDenun,distDenun,domDenun,emailDenun,telDenun,celDenun,reservaIden,descDenun,listDenunciados,pruebasConf,ubiPuebas,compromiso,comCorreo) values (_fechaDenuncia,_tipDenuncia,_rucDenun,_razonDenun,_tipDocumento,_numDoc,_nombDenun,_apPatDenun,_apMatDenun,_depDenun,_provDenun,_distDenun,_domDenun,_emailDenun,_telDenun,_celDenun,_reservaIden,_descDenun,_listDenunciados,_pruebasConf,_ubiPuebas,_compromiso,_comCorreo);
end$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `REG_DEN_NATURAL`(IN `_FechaDenuncia` DATE, IN `_tipDenuncia` INT(11), IN `_tipDocumento` INT(11), IN `_numDoc` TEXT, IN `_nombDenun` TEXT, IN `_apPatDenun` TEXT, IN `_apMatDenun` TEXT, IN `_depDenun` INT(5), IN `_provDenun` INT(5), IN `_distDenun` INT(5), IN `_domDenun` TEXT, IN `_emailDenun` TEXT, IN `_telDenun` TEXT, IN `_celDenun` TEXT, IN `_reservaIden` TEXT, IN `_descDenun` TEXT, IN `_listDenunciados` TEXT, IN `_pruebasConf` TEXT, IN `_ubiPuebas` TEXT, IN `_compromiso` TEXT, IN `_comCorreo` INT(11))
begin
insert into da_tab_denuncias(FechaDenuncia,tipDenuncia,tipDocumento,numDoc,nombDenun,apPatDenun,apMatDenun,depDenun,provDenun,distDenun,domDenun,emailDenun,telDenun,celDenun,reservaIden,descDenun,listDenunciados,pruebasConf,ubiPuebas,compromiso,comCorreo) values (_fechaDenuncia,_tipDenuncia,_tipDocumento,_numDoc,_nombDenun,_apPatDenun,_apMatDenun,_depDenun,_provDenun,_distDenun,_domDenun,_emailDenun,_telDenun,_celDenun,_reservaIden,_descDenun,_listDenunciados,_pruebasConf,_ubiPuebas,_compromiso,_comCorreo);
end$$
...
--
-- Estructura de tabla para la tabla `da_tab_areas`
--

CREATE TABLE IF NOT EXISTS `da_tab_areas` (
  `idArea` int(11) NOT NULL,
  `descArea` text NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `da_tab_areas`
--

INSERT INTO `da_tab_areas` (`idArea`, `descArea`) VALUES
(1, 'Dirección General'),
(2, 'Órgano de Control Institucional'),
(3, 'Oficina Ejecutiva de Planeamiento Estratégico'),
(4, 'Oficina Ejecutiva de Administración'),
(5, 'Oficina de Asesoría Jurídica'),
(6, 'Oficina de Personal'),
(7, 'Oficina de Logística'),
(8, 'Oficina de Epidemiología y Salud Ambiental'),
(9, 'Oficina de Gestión de Calidad'),
(10, 'Oficina de Economía'),
(11, 'Oficina de Servicios Generales'),
(12, 'Oficina de Seguros'),
(13, 'Oficina de Comunicaciones'),
(14, 'Oficina de Estadística e Informática'),
(15, 'Oficina de Apoyo a la Docencia e Investigación'),
...
(20, 'Departamento de Anestesiología y Centro Quirúrgico'),
(21, 'Departamento de Cirugía'),
(22, 'Departamento de Pedíatria'),
(23, 'Departamento de Ginecología y Obstetricia'),
(24, 'Departamento de Psicología'),
(25, 'Departamento de Farmacia'),
(26, 'Departamento de Consulta Externa y Hospitalización'),
(27, 'Departamento de Nutrición y Dietetica'),
(28, 'Departamento de Patología Clínica y Anatomía Patológica'),
(29, 'Departamento de Diagnóstico por Imágenes'),
(30, 'Departamento de Enfermería');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `da_tab_denuncias`
--

CREATE TABLE IF NOT EXISTS `da_tab_denuncias` (
  `idDenuncia` int(11) NOT NULL,
  `FechaDenuncia` date NOT NULL,
  `tipDenuncia` int(11) DEFAULT NULL,
  `tipDocumento` int(11) DEFAULT NULL,
  `rucDenun` text COLLATE utf8_spanish_ci,
  `razonDenun` text COLLATE utf8_spanish_ci,
  `numDoc` text COLLATE utf8_spanish_ci,
  `nombDenun` text COLLATE utf8_spanish_ci,
  `apPatDenun` text COLLATE utf8_spanish_ci,
  `apMatDenun` text COLLATE utf8_spanish_ci,
  `depDenun` int(5) DEFAULT NULL,
  `provDenun` int(5) DEFAULT NULL,
  `distDenun` int(5) DEFAULT NULL,
  `domDenun` text COLLATE utf8_spanish_ci,
  `emailDenun` text COLLATE utf8_spanish_ci,
  `telDenun` text COLLATE utf8_spanish_ci,
  `celDenun` text COLLATE utf8_spanish_ci,
  `reservaIden` text COLLATE utf8_spanish_ci,
  `descDenun` text COLLATE utf8_spanish_ci,
  `listDenunciados` text COLLATE utf8_spanish_ci,
  `pruebasConf` text COLLATE utf8_spanish_ci,
  `ubiPuebas` text COLLATE utf8_spanish_ci,
  `compromiso` text COLLATE utf8_spanish_ci,
  `comCorreo` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `da_tab_departamentos`
--

CREATE TABLE IF NOT EXISTS `da_tab_departamentos` (
  `idDep` int(5) NOT NULL,
  `descDep` varchar(50) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `da_tab_departamentos`
--

INSERT INTO `da_tab_departamentos` (`idDep`, `descDep`) VALUES
(1, 'AMAZONAS'),
(2, 'ANCASH'),
(3, 'APURIMAC'),
(4, 'AREQUIPA'),
...
--
-- Estructura de tabla para la tabla `da_tab_distritos`
--

CREATE TABLE IF NOT EXISTS `da_tab_distritos` (
  `idDist` int(5) NOT NULL,
  `descDist` varchar(50) NOT NULL,
  `idProv` int(5) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=1832 DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `da_tab_distritos`
--

INSERT INTO `da_tab_distritos` (`idDist`, `descDist`, `idProv`) VALUES
(1, 'CHACHAPOYAS', 1),
(2, 'ASUNCION', 1),
(3, 'BALSAS', 1),
(4, 'CHETO', 1),
...
--
-- Estructura de tabla para la tabla `da_tab_provincias`
--

CREATE TABLE IF NOT EXISTS `da_tab_provincias` (
  `idProv` int(5) NOT NULL,
  `descProv` varchar(50) NOT NULL,
  `idDep` int(5) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=194 DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `da_tab_provincias`
--

INSERT INTO `da_tab_provincias` (`idProv`, `descProv`, `idDep`) VALUES
(1, 'CHACHAPOYAS ', 1),
(2, 'BAGUA', 1),
(3, 'BONGARA', 1),
(4, 'CONDORCANQUI', 1),
...
--
-- Estructura de tabla para la tabla `da_tab_tipo_doc`
--

CREATE TABLE IF NOT EXISTS `da_tab_tipo_doc` (
  `idTipoDoc` int(11) NOT NULL,
  `descTipoDoc` text COLLATE utf8_spanish_ci NOT NULL,
  `aliasTipoDoc` text COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `da_tab_tipo_doc`
--

INSERT INTO `da_tab_tipo_doc` (`idTipoDoc`, `descTipoDoc`, `aliasTipoDoc`) VALUES
(1, 'DNI', 'DNI'),
(2, 'CE', 'CE'),
...
--
-- Estructura de tabla para la tabla `da_tab_tipo_persona`
--

CREATE TABLE IF NOT EXISTS `da_tab_tipo_persona` (
  `idtipPersona` int(11) NOT NULL,
  `descTipoPersona` text COLLATE utf8_spanish_ci NOT NULL,
  `aliasTPersona` text COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `da_tab_tipo_persona`
--

INSERT INTO `da_tab_tipo_persona` (`idtipPersona`, `descTipoPersona`, `aliasTPersona`) VALUES
(1, 'Persona Natural', 'Natural'),
(2, 'Persona Jurídica', 'Jurídica'),
(3, 'Anónimo', 'Anónimo');
...
--
-- Indices de la tabla `da_tab_areas`
--
ALTER TABLE `da_tab_areas`
  ADD PRIMARY KEY (`idArea`);

--
-- Indices de la tabla `da_tab_denuncias`
--
ALTER TABLE `da_tab_denuncias`
  ADD PRIMARY KEY (`idDenuncia`);

--
-- Indices de la tabla `da_tab_departamentos`
--
ALTER TABLE `da_tab_departamentos`
  ADD PRIMARY KEY (`idDep`);

--
-- Indices de la tabla `da_tab_distritos`
--
ALTER TABLE `da_tab_distritos`
  ADD PRIMARY KEY (`idDist`);

--
-- Indices de la tabla `da_tab_provincias`
--
ALTER TABLE `da_tab_provincias`
  ADD PRIMARY KEY (`idProv`);

--
-- Indices de la tabla `da_tab_tipo_doc`
--
ALTER TABLE `da_tab_tipo_doc`
  ADD PRIMARY KEY (`idTipoDoc`);

--
-- Indices de la tabla `da_tab_tipo_persona`
--
ALTER TABLE `da_tab_tipo_persona`
  ADD PRIMARY KEY (`idtipPersona`);
...
--
-- AUTO_INCREMENT de la tabla `da_tab_areas`
--
ALTER TABLE `da_tab_areas`
  MODIFY `idArea` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=31;
--
-- AUTO_INCREMENT de la tabla `da_tab_denuncias`
--
ALTER TABLE `da_tab_denuncias`
  MODIFY `idDenuncia` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `da_tab_departamentos`
--
ALTER TABLE `da_tab_departamentos`
  MODIFY `idDep` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=26;
--
-- AUTO_INCREMENT de la tabla `da_tab_distritos`
--
ALTER TABLE `da_tab_distritos`
  MODIFY `idDist` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1832;
--
-- AUTO_INCREMENT de la tabla `da_tab_provincias`
--
ALTER TABLE `da_tab_provincias`
  MODIFY `idProv` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=194;
--
-- AUTO_INCREMENT de la tabla `da_tab_tipo_doc`
--
ALTER TABLE `da_tab_tipo_doc`
  MODIFY `idTipoDoc` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de la tabla `da_tab_tipo_persona`
--
ALTER TABLE `da_tab_tipo_persona`
  MODIFY `idtipPersona` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
